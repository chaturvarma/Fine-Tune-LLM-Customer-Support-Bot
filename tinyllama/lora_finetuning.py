...
def finetune_category_tinyllama(df_train, model, tokenizer, device, lora_params: dict, training_params: dict):
...
def finetune_intent_tinyllama(df_train, model, tokenizer, device, intents, lora_params: dict, training_params: dict):
...
def evaluate_model_tinyllama(df_test, model_category, model_intent, tokenizer, device, categories, intents):
    predictions = []
    correct_category = 0
    correct_intent = 0
    total = len(df_test)
